...
* **A-desk**, PR A's ADR-0031 band — still `**NOT RUN**`, unchanged by this PR.
...
| **A-desk: the ADR-0031 band for `parse serialize alloc validate density`, n = 20 each side, two worktrees alternating, on a §9 boot with mitigations in force** | **NOT RUN** |
