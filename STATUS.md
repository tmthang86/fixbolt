...
Five of them, and **four were about this repository's own checks rather than about FIX**:
...
| A reversal is only a test if the input is one the two versions disagree about — **twice, unrelated code** | [a-reversal-needs-an-input-where-the-answers-differ](docs/reference/a-reversal-needs-an-input-where-the-answers-differ.md) |
