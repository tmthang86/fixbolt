...
went green. The review fixes `970b612` and `6e716a5` came after that run; **the closing commit's
CI run is `<pending>`**. **No figure was produced.** Every gate ran on the Linux desk in the §9
