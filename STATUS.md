...
Wave A step 3: [message-log](docs/plans/2026-09-03-message-log.md) (item 44) — **steps 0
through 3c are done**, `[2026-09-04]`. What is left is **step 4**, the header and CRC32 for the
journal's on-disk format, which is the only part of that plan that touches `journal.rs` at all.
