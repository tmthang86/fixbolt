...
| Plan in flight | **[2026-08-29-session-initiator.md](docs/plans/2026-08-29-session-initiator.md)** — **Approved 2026-08-30**, all four steps, nothing built yet. `DESIGN.md` §7 step 5: the initiator role, 51 mirrored definitions, and interop against `libquickfix` in CI. The last of those puts a C++ toolchain in CI for good, and that cost was agreed when the plan was approved |
