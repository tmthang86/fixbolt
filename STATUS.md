...
| **[the-doc-set](docs/plans/2026-09-02-the-doc-set.md)** | 33 — **approved 2026-09-02**, five phases. A merges on its own; **C and D do not wait on `library`**, only E does. **Written twice**: the first draft was measured against `73e48c6`, and 73 commits had landed by the time it was written down — `GUIDE.md` had already grown 501 → 1054 lines and absorbed operations, so `OPERATIONS.md` was dropped before it was written. Sửa 1 in the plan records it |
