...
two names instead of one: docs pass (step 5) is landing on `plan/group-count-pass-and-is-admin`,
not yet merged**. Steps 0–4 of
[the-group-count-pass-and-is-admin](docs/plans/2026-09-20-the-group-count-pass-and-is-admin.md)
are built and committed (`585e11c`, `c8709a1`, `438228a`, `8e81aae`, `6e84ef1`); the manager's
gate re-run, the two reversals and the CI run id for the closing commit are still owed. See
