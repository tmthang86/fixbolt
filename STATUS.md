...
- **`[2026-09-08]` Nothing here has seen a real venue send a microsecond `52=`.** Half A of
  ...
  an outside opinion, from another implementation over a real socket. What is still missing is a
