...
Last updated: **2026-09-05** — **the journal knows how far it has counted, and closing that found the same hole in the other direction.**

## Start here — 2026-09-05, latest: a journal that knows its numbering, and a gate that found what the tests could not
