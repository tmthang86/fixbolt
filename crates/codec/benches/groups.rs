...
60=20260828-00:00:00.000\x0110=000\x01";
    ...
    harness::bench("walk 1 group, 2 entries, 2 members", CEILING_SMALL, || {
    ...
    harness::bench("walk 4 levels, 61-tag member list", CEILING_DEEP, || {
    ...
    // in the 61-tag one.
    harness::bench("group_members contains, 61 tags", CEILING_CONTAINS, || {
    ...
    harness::bench("encode 1 group, 2 entries", CEILING_ENCODE, || {
