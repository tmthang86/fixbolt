...
Phase 1 — a FIX 4.4 engine you can actually deploy          ← all current work
  ...
  │                            reason ✓ — ordered shutdown · sequence-number admin ·
  │                            offline journal reader remain (item 30 a, c, e)
  └── library               ← not started
