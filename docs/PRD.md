...
Phase 1 — a FIX 4.4 engine you can actually deploy          ← all current work
  ...
  │                            reason ✓ · sequence-number admin ✓ — ordered shutdown ·
  │                            offline journal reader remain (item 30 a, e)
  └── library               ← not started
