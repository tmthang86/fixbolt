...
Phase 1 — a FIX 4.4 engine you can actually deploy          ← all current work
  ...
  │                            — ordered shutdown is all that remains (item 30 a)
  └── library               ← not started
