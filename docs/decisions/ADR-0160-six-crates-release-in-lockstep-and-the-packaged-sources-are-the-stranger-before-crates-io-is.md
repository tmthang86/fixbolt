...
- **Superseded in part — 2026-09-24:** decision 6's third sentence and decision 7's second half (what happens after a crates.io publish) by [ADR-0161](ADR-0161-0-1-0-is-a-git-tag-not-a-crates-io-upload-and-the-stranger-and-the-semver-gate-read-the-tag.md).
