...
| 3 ✅ | `[2026-09-04]` **Xong.** `Connection::unsent_bytes()` đếm byte còn trong `tx` khi socket chết; `EventKind::MessageLogUnsent { bytes }` phát ở nhánh `Turn::Gone`, sau `L::LOGS`. Hai reversal, hai lần đỏ |
