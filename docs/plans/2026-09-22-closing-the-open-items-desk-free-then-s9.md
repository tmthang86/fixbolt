...
| P7 | *(commit này)* | `STATUS.md` *Start here 2026-09-22, night*; `check-links.py` → `no dead internal links` | CI run id ghi sau khi run kết thúc, trước R |
